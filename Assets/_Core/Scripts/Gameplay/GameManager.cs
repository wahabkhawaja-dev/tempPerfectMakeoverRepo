...
public class GameManager : MonoBehaviour
{
    ...
    void EnsureSaveSystem()
    {
        ...
        SaveSystem existing = FindObjectOfType<SaveSystem>(true);
        if (existing == null)
        {
    ...
    void EnsureLoadingManager()
    {
        ...
        LoadingManager existing = FindObjectOfType<LoadingManager>(true);
        if (existing != null)
            return;
        ...
        UI_Manager ui = FindObjectOfType<UI_Manager>(true);
        if (ui != null)
    ...
    void BindSceneLevel()
    {
        if (currentLevel == null)
            currentLevel = FindObjectOfType<LevelData>(true);
