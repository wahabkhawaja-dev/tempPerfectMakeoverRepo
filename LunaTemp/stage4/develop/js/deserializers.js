...
Deserializers["BD_Fold"] = function (request, data, root) {
  ...
  request.r(i963[7], i963[8], 0, i962, 'foldMaterial')
  request.r(i963[9], i963[10], 0, i962, 'backSideSprite')
  i962.maxSideOffset = i963[11]
  i962.foldBackDuration = i963[12]
  i962.instantFoldAmount = i963[13]
  i962.useSmoothRelease = !!i963[14]
  i962.completionLimit = i963[15]
  i962.afterCompletionTravelTo = i963[16]
  i962.OnComplete = request.d('UnityEngine.Events.UnityEvent', i963[17], i962.OnComplete)
  i962.currentProgress = i963[18]
  i962.innerShadowStrength = i963[19]
  request.r(i963[20], i963[21], 0, i962, 'dragAudioSource')
  request.r(i963[22], i963[23], 0, i962, 'dragStartClip')
  request.r(i963[24], i963[25], 0, i962, 'completionClip')
  i962.audioFadeSpeed = i963[26]
  i962.audioMoveThreshold = i963[27]
  i962.hapticInterval = i963[28]
  return i962
}
...
Deserializers.buildID = "8592134a-36a2-4fac-9806-8930fbafe53e";
