...
public class BD_Fold : MonoBehaviour
{
    ...
    void TryBeginDrag([Bridge.Ref] Vector2 screenPos)
    {
    ...
    bool IsCornerAllowed([Bridge.Ref] Vector2 corner)
    {
    ...
    void UpdateDragLogic([Bridge.Ref] Vector2 targetUV)
    {
    ...
    void ApplyToMat(Material mat, [Bridge.Ref] Vector2 dir, float dist)
    {
    ...
    Vector2 GetNearestStickerCorner([Bridge.Ref] Vector2 mouseUV)
    {
        return new Vector2(
    ...
    Vector2 GetOppositeCorner([Bridge.Ref] Vector2 corner)
    {
        return new Vector2(
    ...
    Vector2 WorldToUV([Bridge.Ref] Vector2 worldPos)
    {
