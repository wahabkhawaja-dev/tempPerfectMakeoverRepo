...
public class Level3_Face : LevelData
{
    [Space()]
    [Header("----------------------------------------------------------------------------------")]
    [Space()]
    ...
    public void EyeLinerOpen_2()
    {
        ...
        {
            CameraController.Instance.MoveCamera(ZoomStep2B.CameraPos, ZoomStep2B.CameraFOV, 1.2f);
    ...
    public void ShiftSideToLeft2()
    {
        ...
        CameraController.Instance.MoveCamera(ZoomStep2C.CameraPos, ZoomStep2C.CameraFOV);
