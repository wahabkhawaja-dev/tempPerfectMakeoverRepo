...
public class Level1_Hair_Playable_Step47 : LevelData
{
    [Space()]
    [Header("----------------------------------------------------------------------------------")]
    ...
    IEnumerator Start()
    {
        ...
        // PLAYABLE: no save resume — same ForceComplete + StartStep as original switch.
        ForceCompleteStep4(); ForceCompleteStep2b();
    ...
    public void Step1Complete()
    {
        ...
        { PlayableFadeCover.Cover(); ForceCompleteStep4(); Invoke(nameof(StartStep5), 0.25f); PlayableFadeCover.Reveal(); }
    ...
    public void Step3Complete()
    {
        ...
        { PlayableFadeCover.Cover(); ForceCompleteStep4(); Invoke(nameof(StartStep5), 0.5f); PlayableFadeCover.Reveal(); }
